...
public class D09_ShoppingCart {
    ...
    public void userClickOnAddToCartButtonForElement(int arg0) {
        home.addToCartBtn.get(arg0).click();
    }
    ...
    @When("User click on Add to cart button three times on the same element")
    public void userClickOnAddToCartButtonThreeTimesOnTheSameElement() throws InterruptedException {
        for (int i=1;i<=3;i++){
            home.addToCartBtn.get(2).click();
            Thread.sleep(1000);
        }
    }
